...
class TuplesDataset(data.Dataset):
    ...
    def __init__(self, name, mode, imsize=None, nnum=5, qsize=1000, poolsize=1000, transform=None, loader=default_loader):
    ...
    def create_epoch_tuples(self, net):
        ...
        with torch.no_grad():
            ...
            loader = torch.utils.data.DataLoader(
                ...
                batch_size=1, shuffle=False, num_workers=24, pin_memory=True
            )
